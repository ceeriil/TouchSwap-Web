    ...
    >
      <g clipPath="url(#clip0_319_3426)">
        ...
        <path
          ...
          fill="url(#paint0_radial_319_3426)"
        />
        <g opacity="0.2">
          ...
          <g style={{ mixBlendMode: "overlay" }} opacity="0.4">
            <ellipse
              ...
              rx="4.5"
              ry="3"
              transform="rotate(5.94621 39.5 24)"
              fill="url(#paint4_linear_319_3426)"
            />
          </g>
          <g style={{ mixBlendMode: "overlay" }} opacity="0.56">
            <ellipse
              ...
              rx="4.5"
              ry="3"
              transform="rotate(-4.33457 60.5 8.99994)"
              fill="url(#paint5_linear_319_3426)"
            />
          </g>
          <g style={{ mixBlendMode: "overlay" }}>
            <ellipse
        ...
        <g opacity="0.2">
          <path
            opacity="0.74"
            d="M43.8189 20.625L30.9439 7.375L18.0689 20.625H26.3189V47.5H35.5689V20.625H43.8189Z"
            fill="#57E587"
          />
          <path
            opacity="0.74"
            d="M16.6184 12.5218L10.2812 6L3.94394 12.5218H8.00469V25.75H12.5576V12.5218H16.6184Z"
            fill="#57E587"
          />
          <path
            opacity="0.74"
            d="M60.5732 24.5787L51.5086 15.25L42.4439 24.5787H48.2524V43.5H54.7648V24.5787H60.5732Z"
            fill="#57E587"
          />
          <path
            opacity="0.74"
            d="M25.5732 33.0787L16.5086 23.75L7.44394 33.0787H13.2524V52H19.7648V33.0787H25.5732Z"
            fill="#57E587"
          />
        </g>
        <path
          d="M42.3523 23.6972L19.2454 11.1152L33.4036 27.524L42.3523 23.6972Z"
          fill="url(#paint8_linear_319_3426)"
        />
        <path
          d="M19.2454 11.1153L12.3809 36.5143L21.3296 32.6874L19.2454 11.1153Z"
          fill="url(#paint9_linear_319_3426)"
        />
        <path
          d="M12.3809 36.5143L35.4877 49.0962L21.3296 32.6874L12.3809 36.5143Z"
          fill="url(#paint10_linear_319_3426)"
        />
        <path
          d="M33.4036 27.524L35.4877 49.0962L42.3523 23.6972L33.4036 27.524Z"
          fill="url(#paint11_linear_319_3426)"
        />
        <path
          d="M33.4036 27.524L19.2454 11.1152L21.3295 32.6874L33.4036 27.524Z"
          fill="url(#paint12_linear_319_3426)"
        />
        <path
          d="M21.3295 32.6875L35.4877 49.0963L33.4036 27.5241L21.3295 32.6875Z"
          fill="url(#paint13_linear_319_3426)"
        />
        <path
          opacity="0.5"
