    ...
    <div>
      {unlocked ? (
        <svg width="75" height="85" viewBox="0 0 75 85" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <defs>
            ...
            <linearGradient
              ...
              gradientUnits="userSpaceOnUse"
            >
              <stop stop-color="#594141" />
              <stop offset="1" stop-color="#413729" />
            </linearGradient>
            <linearGradient
            ...
            >
              <stop stop-color="#765A58" />
              <stop offset="1" stop-color="#645A4B" />
            </radialGradient>
          </defs>
        </svg>
      ) : (
        <svg width="85" height="147" viewBox="0 0 85 147" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <circle cx="42.5" cy="42.5" r="30.2812" stroke="url(#paint3_linear_457_7451)" stroke-width="5.3125" />
